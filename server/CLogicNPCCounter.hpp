...
{
public:
	CEntityIOOutput m_OnMinCountAll; // 0x4d8	
	CEntityIOOutput m_OnMaxCountAll; // 0x500	
	CEntityOutputTemplate< float32 > m_OnFactorAll; // 0x528	
	CEntityOutputTemplate< float32 > m_OnMinPlayerDistAll; // 0x550	
	CEntityIOOutput m_OnMinCount_1; // 0x578	
	CEntityIOOutput m_OnMaxCount_1; // 0x5a0	
	CEntityOutputTemplate< float32 > m_OnFactor_1; // 0x5c8	
	CEntityOutputTemplate< float32 > m_OnMinPlayerDist_1; // 0x5f0	
	CEntityIOOutput m_OnMinCount_2; // 0x618	
	CEntityIOOutput m_OnMaxCount_2; // 0x640	
	CEntityOutputTemplate< float32 > m_OnFactor_2; // 0x668	
	CEntityOutputTemplate< float32 > m_OnMinPlayerDist_2; // 0x690	
	CEntityIOOutput m_OnMinCount_3; // 0x6b8	
	CEntityIOOutput m_OnMaxCount_3; // 0x6e0	
	CEntityOutputTemplate< float32 > m_OnFactor_3; // 0x708	
	CEntityOutputTemplate< float32 > m_OnMinPlayerDist_3; // 0x730	
