...
public:
	JointMotion_t m_nLinearMotionX; // 0x558	
	JointMotion_t m_nLinearMotionY; // 0x55c	
	JointMotion_t m_nLinearMotionZ; // 0x560	
	...
	GameTime_t m_flBreakAfterTimeStartTimeX; // 0x594	
	GameTime_t m_flBreakAfterTimeStartTimeY; // 0x598	
	GameTime_t m_flBreakAfterTimeStartTimeZ; // 0x59c	
	...
	GameTime_t m_flNotifyForceLastTimeX; // 0x5c4	
	GameTime_t m_flNotifyForceLastTimeY; // 0x5c8	
	GameTime_t m_flNotifyForceLastTimeZ; // 0x5cc	
...
public:
	JointMotion_t m_nAngularMotionX; // 0x5d4	
	JointMotion_t m_nAngularMotionY; // 0x5d8	
	JointMotion_t m_nAngularMotionZ; // 0x5dc	
...
public:
	CEntityIOOutput m_NotifyForceReachedX; // 0x608	
	CEntityIOOutput m_NotifyForceReachedY; // 0x630	
	CEntityIOOutput m_NotifyForceReachedZ; // 0x658	
