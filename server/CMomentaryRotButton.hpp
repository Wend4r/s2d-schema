...
{
public:
	CEntityOutputTemplate< float32 > m_Position; // 0x938	
	CEntityIOOutput m_OnUnpressed; // 0x960	
	CEntityIOOutput m_OnFullyOpen; // 0x988	
	CEntityIOOutput m_OnFullyClosed; // 0x9b0	
	CEntityIOOutput m_OnReachedPosition; // 0x9d8	
