...
public:
	...
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_DashParticle; // 0x14f0	
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_DownDashParticle; // 0x15d0	
	// MPropertyStartGroup "Sounds"
	CSoundEventName m_strArriveSound; // 0x16b0	
	CSoundEventName m_strStaminaDrainedSound; // 0x16c0	
	// MPropertyStartGroup "Camera"
	CitadelCameraOperationsSequence_t m_cameraSequenceGroundDashActivate; // 0x16d0	
	CitadelCameraOperationsSequence_t m_cameraSequenceAirDashActivate; // 0x1750	
