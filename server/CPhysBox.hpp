...
public:
	...
	CEntityIOOutput m_OnDamaged; // 0x868	
	CEntityIOOutput m_OnAwakened; // 0x890	
	CEntityIOOutput m_OnMotionEnabled; // 0x8b8	
	CEntityIOOutput m_OnPlayerUse; // 0x8e0	
	CEntityIOOutput m_OnStartTouch; // 0x908	
	CHandle< CBasePlayerPawn > m_hCarryingPlayer; // 0x930	
