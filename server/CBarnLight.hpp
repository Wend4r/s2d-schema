...
public:
	...
	// MNetworkEnable
	// MNetworkChangeCallback "RenderingChanged"
	GameTime_t m_flLightStyleStartTime; // 0x7a0	
private:
...
public:
	...
	// MNetworkEnable
	CNetworkUtlVectorBase< CHandle< CBaseModelEntity > > m_LightStyleTargets; // 0x7d8	
	CEntityIOOutput m_StyleEvent[4]; // 0x7f0	
private:
	[[maybe_unused]] uint8_t __pad0890[0x20]; // 0x890
public:
	// MNetworkEnable
	// MNetworkChangeCallback "RenderingChanged"
	CStrongHandle< InfoForResourceTypeCTextureBase > m_hLightCookie; // 0x8b0	
	// MNetworkEnable
	// MNetworkChangeCallback "RenderingChanged"
...
public:
	// MNetworkEnable
	// MNetworkChangeCallback "RenderingChanged"
	CNetworkUtlVectorBase< uint16 > m_VisClusters; // 0xa68	
