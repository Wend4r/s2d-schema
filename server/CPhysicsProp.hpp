...
public:
	CEntityIOOutput m_MotionEnabled; // 0xb30	
	CEntityIOOutput m_OnAwakened; // 0xb58	
	CEntityIOOutput m_OnAwake; // 0xb80	
	CEntityIOOutput m_OnAsleep; // 0xba8	
	CEntityIOOutput m_OnPlayerUse; // 0xbd0	
	CEntityIOOutput m_OnOutOfWorld; // 0xbf8	
	CEntityIOOutput m_OnPlayerPickup; // 0xc20	
...
public:
	GameTime_t m_fNextCheckDisableMotionContactsTime; // 0xc70	
...
public:
	CPhysicsProp::CrateType_t m_CrateType; // 0xc94	
