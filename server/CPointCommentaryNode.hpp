...
public:
	...
	CHandle< CBaseEntity > m_hViewTarget; // 0x998	
	CHandle< CBaseEntity > m_hViewTargetAngles; // 0x99c	
	CUtlSymbolLarge m_iszViewPosition; // 0x9a0	
	// MNetworkEnable
	CHandle< CBaseEntity > m_hViewPosition; // 0x9a8	
	CHandle< CBaseEntity > m_hViewPositionMover; // 0x9ac	
...
public:
	GameTime_t m_flFinishedTime; // 0x9b4	
...
public:
	...
	GameTime_t m_flAbortedPlaybackAt; // 0x9ec	
	CEntityIOOutput m_pOnCommentaryStarted; // 0x9f0	
	CEntityIOOutput m_pOnCommentaryStopped; // 0xa18	
	// MNetworkEnable
...
public:
	// MNetworkEnable
	GameTime_t m_flStartTime; // 0xa44	
	// MNetworkEnable
