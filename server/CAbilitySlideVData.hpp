...
public:
	...
	float m_flLandedFlatGroundFrictionGraceTime; // 0x15b4	
	...
	float m_flSlideActivationProbeForwardOffset; // 0x162c	
	// MPropertyDescription "Maximum distance between probe samples"
	float m_flMaxDistanceBetweenProbeSamples; // 0x1630	
