...
{
public:
	CAnimGraphParamOptionalRef< bool > m_bShielded; // 0x3f0	
	CAnimGraphParamOptionalRef< bool > m_bAlert; // 0x408	
	CAnimGraphParamOptionalRef< char* > m_pszAttackLeanPosition; // 0x420	
	CAnimGraphParamOptionalRef< char* > m_pszOrbDrop; // 0x440	
