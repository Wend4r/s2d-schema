...
{
public:
	CAnimGraphParamOptionalRef< bool > m_bShielded; // 0x470	
	CAnimGraphParamOptionalRef< bool > m_bAlert; // 0x488	
	CAnimGraphParamOptionalRef< char* > m_pszAttackLeanPosition; // 0x4a0	
	CAnimGraphParamOptionalRef< char* > m_pszOrbDrop; // 0x4c0	
