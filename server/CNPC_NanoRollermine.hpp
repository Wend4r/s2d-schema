...
{
private:
	[[maybe_unused]] uint8_t __pad1550[0x38]; // 0x1550
public:
	// MNetworkEnable
	float m_flForwardSpeed; // 0x1588	
private:
	[[maybe_unused]] uint8_t __pad158c[0x44]; // 0x158c
public:
	// MNetworkEnable
	CHandle< CBaseEntity > m_hOwnerPawn; // 0x15d0	
