...
public:
	ConstraintSoundInfo m_soundInfo; // 0x558	
	CEntityIOOutput m_NotifyMinLimitReached; // 0x5e0	
	CEntityIOOutput m_NotifyMaxLimitReached; // 0x608	
	bool m_bAtMinLimit; // 0x630	
	bool m_bAtMaxLimit; // 0x631	
private:
	[[maybe_unused]] uint8_t __pad0632[0x2]; // 0x632
public:
	constraint_hingeparams_t m_hinge; // 0x634	
...
public:
	CEntityIOOutput m_OnStartMoving; // 0x6a0	
	CEntityIOOutput m_OnStopMoving; // 0x6c8	
