...
public:
	CUtlVector< CHandle< CBasePropDoor > > m_hDoorList; // 0xc40	
...
public:
	// MNetworkEnable
	DoorState_t m_eDoorState; // 0xc60	
	// MNetworkEnable
...
public:
	...
	// MNetworkEnable
	CHandle< CBasePropDoor > m_hMaster; // 0xd20	
private:
	[[maybe_unused]] uint8_t __pad0d24[0x4]; // 0xd24
public:
	CEntityIOOutput m_OnBlockedClosing; // 0xd28	
	CEntityIOOutput m_OnBlockedOpening; // 0xd50	
	CEntityIOOutput m_OnUnblockedClosing; // 0xd78	
	CEntityIOOutput m_OnUnblockedOpening; // 0xda0	
	CEntityIOOutput m_OnFullyClosed; // 0xdc8	
	CEntityIOOutput m_OnFullyOpen; // 0xdf0	
	CEntityIOOutput m_OnClose; // 0xe18	
	CEntityIOOutput m_OnOpen; // 0xe40	
	CEntityIOOutput m_OnLockedUse; // 0xe68	
	CEntityIOOutput m_OnAjarOpen; // 0xe90	
