...
enum class EModifierState : uint32_t
{
	...
	MODIFIER_STATE_RESPAWN_CREDIT_PERSONAL = 0x50,
	MODIFIER_STATE_DISPLAY_LIFETIME = 0x51,
	MODIFIER_STATE_MELEE_DISABLED = 0x52,
	MODIFIER_STATE_MELEE_DISABLED_DEBUFF = 0x53,
	MODIFIER_STATE_GLITCHED = 0x54,
	MODIFIER_STATE_SLIDING_DISABLED = 0x55,
	MODIFIER_STATE_RELOAD_DISABLED = 0x56,
	MODIFIER_STATE_RELOAD_MELEE_FULL_SPEED = 0x57,
	MODIFIER_STATE_MANUAL_RELOAD_DISABLED = 0x58,
	MODIFIER_STATE_UNIT_STATUS_HEALTH_HIDDEN = 0x59,
	MODIFIER_STATE_UNIT_STATUS_HIDDEN = 0x5a,
	MODIFIER_STATE_FADE_ALPHA_TO_ZERO = 0x5b,
	MODIFIER_STATE_FRIENDLY_FIRE_ENABLED = 0x5c,
	MODIFIER_STATE_FLYING = 0x5d,
	MODIFIER_STATE_SCOPED = 0x5e,
	MODIFIER_STATE_ROLLING_BALL = 0x5f,
	MODIFIER_STATE_SLOW_IMMUNE = 0x60,
	MODIFIER_STATE_ROOT_IMMUNE = 0x61,
	MODIFIER_STATE_IS_MELEE_TARGET = 0x62,
	MODIFIER_STATE_GLOW_TO_ALLIES_AS_ENEMY = 0x63,
	MODIFIER_STATE_LADDER_DISABLE = 0x64,
	MODIFIER_STATE_IGNORE_BULLETS = 0x65,
	MODIFIER_STATE_IGNORE_MELEE = 0x66,
	MODIFIER_STATE_HIDE_CROSSHAIR = 0x67,
	MODIFIER_STATE_HIDE_STAMINA = 0x68,
	MODIFIER_STATE_HIDE_AMMO = 0x69,
	MODIFIER_STATE_APPLY_VERTICAL_DRAG = 0x6a,
	MODIFIER_STATE_FALSE_DEATH = 0x6b,
	MODIFIER_STATE_NO_WINDUP = 0x6c,
	MODIFIER_STATE_TITAN_LASER_VALID_TARGET = 0x6d,
	MODIFIER_STATE_HAS_HOLLOW_POINT_BULLETS = 0x6e,
	MODIFIER_STATE_SUPPRESS_AIR_DRAG = 0x6f,
	MODIFIER_STATE_GROUND_DASH_EARLY_OUT_WINDOW = 0x70,
	MODIFIER_STATE_ICEBEAMING = 0x71,
	MODIFIER_STATE_IN_ALLY_SMOKE = 0x72,
	MODIFIER_STATE_IN_ENEMY_SMOKE = 0x73,
	MODIFIER_STATE_NIKUMAN_ACTIVE = 0x74,
	MODIFIER_STATE_NO_OUTGOING_DAMAGE = 0x75,
	MODIFIER_STATE_NO_INCOMING_DAMAGE = 0x76,
	MODIFIER_STATE_CHRONO_SWAPPING = 0x77,
	MODIFIER_STATE_BOUNCE_PAD_STOMPING = 0x78,
	MODIFIER_STATE_FLYING_BEETLE_TARGET = 0x79,
	MODIFIER_STATE_DREAMWEAVER_SLEEP = 0x7a,
	MODIFIER_STATE_HOLDING_IDOL = 0x7b,
	MODIFIER_STATE_RETURN_IDOL_AREA = 0x7c,
	MODIFIER_STATE_RETURNING_IDOL = 0x7d,
	MODIFIER_STATE_GALVANIC_STORM_BUFF = 0x7e,
	MODIFIER_STATE_IN_ABILITY_ALLOW_ZOOM = 0x7f,
	MODIFIER_STATE_IN_ABILITY_DISABLE_ZOOM = 0x80,
	MODIFIER_STATE_STAMINA_REGEN_PAUSED = 0x81,
	MODIFIER_STATE_PREMATCH = 0x82,
	MODIFIER_STATE_SELF_DESTRUCT = 0x83,
	MODIFIER_STATE_COOP_TETHER_ACTIVE = 0x84,
	MODIFIER_STATE_COOP_TETHER_LOCKED_TARGET = 0x85,
	MODIFIER_STATE_LOCKED_AIM_ANGLES = 0x86,
	MODIFIER_STATE_ICEPATHING = 0x87,
	MODIFIER_STATE_BACKDOOR_PROTECTED = 0x88,
	MODIFIER_STATE_IN_COMBAT = 0x89,
	MODIFIER_STATE_DASHJUMP_STAMINA_FREE = 0x8a,
	MODIFIER_STATE_YAMATO_SHADOW_FORM = 0x8b,
	MODIFIER_STATE_IN_MID_BOSS_PIT = 0x8c,
	MODIFIER_STATE_CASTS_IGNORE_CHANNELING = 0x8d,
	MODIFIER_STATE_CAN_ACTIVE_RELOAD = 0x8e,
	MODIFIER_STATE_DIGGER_BURROW_CHANNEL = 0x8f,
	MODIFIER_STATE_DIGGER_SPIN = 0x90,
	MODIFIER_STATE_NEAR_REJUVINATOR = 0x91,
	MODIFIER_STATE_IN_TIER3_PHASE2_BOSS_PIT = 0x92,
	MODIFIER_STATE_TAKES_FULLDAMAGE_NO_FALLOFF = 0x93,
	// MPropertySuppressEnumerator
	MODIFIER_STATE_COUNT = 0x94,
	// MPropertySuppressEnumerator
