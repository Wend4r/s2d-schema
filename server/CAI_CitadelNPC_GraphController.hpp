...
{
public:
	CAnimGraphParamOptionalRef< int32 > m_nHitLayerTrigger; // 0x438	
	CAnimGraphParamOptionalRef< char* > m_pszDamageState; // 0x450	
	CAnimGraphParamOptionalRef< float32 > m_fHealth; // 0x470	
