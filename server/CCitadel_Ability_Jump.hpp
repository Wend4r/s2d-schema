...
{
public:
	GameTime_t m_flLastTimeOnZipLine; // 0xad8	
	GameTime_t m_flLastOnGroundTime; // 0xadc	
	GameTime_t m_flPhaseStartTime; // 0xae0	
	GameTime_t m_flJumpTime; // 0xae4	
	EJumpType_t m_LastJumpType; // 0xae8	
	bool m_bShouldCreateAirJumpEffects; // 0xae9	
private:
	[[maybe_unused]] uint8_t __pad0aea[0x2]; // 0xaea
public:
	GameTime_t m_flDoubleJumpFailTime; // 0xaec	
	ECitadelAbilityOrders m_eDoubleJumpFailReason; // 0xaf0	
private:
	[[maybe_unused]] uint8_t __pad0af4[0x11c]; // 0xaf4
public:
	// MNetworkEnable
	CCitadelAutoScaledTime m_flGroundDashJumpStartTime; // 0xc10	
	// MNetworkEnable
	CCitadelAutoScaledTime m_flGroundDashJumpEndTime; // 0xc28	
	// MNetworkEnable
