...
public:
	...
	SolidType_t m_eSolidType; // 0x7aa	
	...
	GameTime_t m_flTimeMovementStart; // 0x7bc	
	GameTime_t m_flTimeMovementStop; // 0x7c0	
	CHandle< CMoverPathNode > m_hStopAtNode; // 0x7c4	
...
public:
	CEntityIOOutput m_OnMovementEnd; // 0x810	
	bool m_bStartAtEnd; // 0x838	
private:
	[[maybe_unused]] uint8_t __pad0839[0x3]; // 0x839
public:
	CFuncMover::OrientationUpdate_t m_eOrientationUpdate; // 0x83c	
	GameTime_t m_flTimeStartOrientationChange; // 0x840	
