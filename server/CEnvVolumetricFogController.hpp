...
public:
	// MNetworkEnable
	GameTime_t m_flStartAnisoTime; // 0x524	
	// MNetworkEnable
	GameTime_t m_flStartScatterTime; // 0x528	
	// MNetworkEnable
	GameTime_t m_flStartDrawDistanceTime; // 0x52c	
	// MNetworkEnable
...
public:
	// MNetworkEnable
	CStrongHandle< InfoForResourceTypeCTextureBase > m_hFogIndirectTexture; // 0x550	
	// MNetworkEnable
