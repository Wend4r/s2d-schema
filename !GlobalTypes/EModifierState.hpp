...
enum class EModifierState : uint32_t
{
	...
	MODIFIER_STATE_GALVANIC_STORM_BUFF = 0x7b,
	MODIFIER_STATE_IN_ABILITY_ALLOW_ZOOM = 0x7c,
	MODIFIER_STATE_IN_ABILITY_DISABLE_ZOOM = 0x7d,
	MODIFIER_STATE_STAMINA_REGEN_PAUSED = 0x7e,
	MODIFIER_STATE_PREMATCH = 0x7f,
	MODIFIER_STATE_SELF_DESTRUCT = 0x80,
	MODIFIER_STATE_COOP_TETHER_ACTIVE = 0x81,
	MODIFIER_STATE_LOCKED_AIM_ANGLES = 0x82,
	MODIFIER_STATE_ICEPATHING = 0x83,
	MODIFIER_STATE_BACKDOOR_PROTECTED = 0x84,
	MODIFIER_STATE_IN_COMBAT = 0x85,
	MODIFIER_STATE_DASHJUMP_STAMINA_FREE = 0x86,
	MODIFIER_STATE_YAMATO_SHADOW_FORM = 0x87,
	MODIFIER_STATE_IN_MID_BOSS_PIT = 0x88,
	MODIFIER_STATE_CASTS_IGNORE_CHANNELING = 0x89,
	MODIFIER_STATE_CAN_ACTIVE_RELOAD = 0x8a,
	MODIFIER_STATE_DIGGER_SPIN = 0x8b,
	MODIFIER_STATE_NEAR_REJUVINATOR = 0x8c,
	// MPropertySuppressEnumerator
	MODIFIER_STATE_COUNT = 0x8d,
	// MPropertySuppressEnumerator
