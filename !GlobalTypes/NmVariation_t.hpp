...
public:
	...
	static char* &Get_s_delimiter(){return *reinterpret_cast<char**>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("NmVariation_t")->m_static_fields[1]->m_instance);};
};
