...
enum class EModifierValue : uint32_t
{
	...
	MODIFIER_VALUE_CRIT_DAMAGE_RECEIVED_SCALE = 0x53,
	// MPropertyFriendlyName "BulletDamageReduction"
	MODIFIER_VALUE_BULLET_DAMAGE_REDUCTION = 0x54,
	MODIFIER_VALUE_BULLET_DAMAGE_REDUCTION_PERCENT = 0x55,
	// MPropertyFriendlyName "BaseWeaponDamageTakenPercent"
	MODIFIER_VALUE_BASE_WEAPON_DAMAGE_TAKEN_PERCENT = 0x56,
	// MPropertyFriendlyName "BaseBulletDamageTakenPercent"
	MODIFIER_VALUE_BASE_BULLET_DAMAGE_TAKEN_PERCENT = 0x57,
	// MPropertyFriendlyName "BaseMeleeDamageTakenPercent"
	MODIFIER_VALUE_BASE_MELEE_DAMAGE_TAKEN_PERCENT = 0x58,
	// MPropertyFriendlyName "MeleeDamageReductionPercent"
	MODIFIER_VALUE_MELEE_DAMAGE_REDUCTION_PERCENT = 0x59,
	MODIFIER_VALUE_MELEE_DAMAGE_INCREASE_PERCENT = 0x5a,
	// MPropertyFriendlyName "StatusResistancePercent"
	MODIFIER_VALUE_STATUS_RESISTANCE = 0x5b,
	// MPropertyFriendlyName "CooldownReduction"
	MODIFIER_VALUE_COOLDOWN_REDUCTION_PERCENTAGE = 0x5c,
	MODIFIER_VALUE_COOLDOWN_MAX_TIME = 0x5d,
	// MPropertyFriendlyName "CooldownBetweenChargeReduction"
	MODIFIER_VALUE_COOLDOWN_BETWEEN_CHARGE_REDUCTION_PERCENTAGE = 0x5e,
	// MPropertyFriendlyName "BonusAbilityCharges"
	MODIFIER_VALUE_BONUS_ABILITY_CHARGES = 0x5f,
	// MPropertyFriendlyName "BonusAbilityDurationPercent"
	MODIFIER_VALUE_BONUS_ABILITY_DURATION_PERCENTAGE = 0x60,
	// MPropertyFriendlyName "BonusMeleeDamage"
	MODIFIER_VALUE_MELEEATTACK_DAMAGE = 0x61,
	MODIFIER_VALUE_MELEEATTACK_DAMAGE_PERCENTAGE = 0x62,
	// MPropertyFriendlyName "BonusMeleeAttackSpeed"
	MODIFIER_VALUE_MELEEATTACK_SPEED = 0x63,
	// MPropertyFriendlyName "BonusMeleeTravelDistancePercent"
	MODIFIER_VALUE_MELEE_TRAVEL_DISTANCE_PERCENTAGE = 0x64,
	// MPropertyFriendlyName "BonusAccuracy"
	MODIFIER_VALUE_FIREARM_ACCURACY_PERCENTAGE = 0x65,
	MODIFIER_VALUE_TURN_SIDEMOVE_PERCENTAGE = 0x66,
	MODIFIER_VALUE_CHARGE_SPEED = 0x67,
	MODIFIER_VALUE_CAN_CANCEL = 0x68,
