...
public:
	...
	CRemapFloat m_SlideEffectRemap; // 0x15b8	
...
public:
	...
	CitadelCameraOperationsSequence_t m_cameraSequenceStartSliding; // 0x1610	
	CitadelCameraOperationsSequence_t m_cameraSequenceEndSliding; // 0x1690	
	// MPropertyStartGroup "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_SlideParticle; // 0x1710	
