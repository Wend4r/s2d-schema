...
public:
	CHandle< C_BaseFlex > m_hOwner; // 0x56c	
	// MNetworkEnable
	// MNetworkPriority "32"
	C_NetworkUtlVectorBase< CHandle< C_BaseFlex > > m_hActorList; // 0x570	
	bool m_bWasPlaying; // 0x588	
private:
	[[maybe_unused]] uint8_t __pad0589[0xf]; // 0x589
public:
	CUtlVector< C_SceneEntity::QueuedEvents_t > m_QueuedEvents; // 0x598	
