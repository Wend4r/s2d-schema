...
public:
	...
	CEmbeddedSubclass< CCitadelModifier > m_ProcModifier; // 0x698	
	// MPropertyStartGroup "Visuals"
	CResourceNameTyped< CWeakHandle< InfoForResourceTypeIParticleSystemDefinition > > m_BuildupSuccessEffect; // 0x6a8	
};
