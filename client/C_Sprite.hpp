...
public:
	// MNetworkEnable
	CStrongHandle< InfoForResourceTypeIMaterial2 > m_hSpriteMaterial; // 0x830	
	// MNetworkEnable
	CHandle< C_BaseEntity > m_hAttachedToEntity; // 0x838	
	// MNetworkEnable
	AttachmentHandle_t m_nAttachment; // 0x83c	
private:
